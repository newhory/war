...
//     version 1.16.0
//     from Assets/War Assets/Resource/BattleInputAction.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/War Assets/Resource/BattleInputAction.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        {
            ""name"": ""Pointer"",
            ""id"": ""49796daf-349b-43e6-ac16-9ed50536213a"",
            ""actions"": [
                {
                    ""name"": ""press"",
                    ""type"": ""Button"",
                    ""id"": ""d4a8328d-bb2e-4573-aa2c-832938a07677"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""position"",
                    ""type"": ""Value"",
                    ""id"": ""e462030c-2a31-4e85-bd07-35792266a00f"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""f02e1fc8-5361-4a8a-8360-5584ecf5753c"",
                    ""path"": ""<Pointer>/press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""368debcb-21f5-4292-83a2-7fecb7e7138f"",
    ...
    ""controlSchemes"": [
        ...
        ~@BattleInputAction()
        {
            UnityEngine.Debug.Assert(!m_Pointer.enabled, "This will cause a leak and performance issues, BattleInputAction.Pointer.Disable() has not been called.");
        }
        ...
        public struct PointerActions
        {
            ...
            /// </summary>
            public PointerActions(@BattleInputAction wrapper) { m_Wrapper = wrapper; }
            /// <summary>
